...
public class FashionMallUserController {
    ...
    public String usersPage(HttpServletRequest request){
        ...
        return "admin/fashion_mall_user";
    }
    ...
    public Result list(@RequestParam Map<String ,Object> params){
        ...
        return ResultGenerator.genSuccessResult(userService.getFashionMallUserPage(pageUtil));
    }
